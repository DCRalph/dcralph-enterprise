...
export default function Contact() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center bg-gray-50">
      <Nav />
      <Card className="m-4 transition-shadow hover:shadow-lg">
        <CardContent>
          <div className="mx-auto grid max-w-4xl items-start gap-16 p-4 font-[sans-serif] md:grid-cols-2">
            <div>
              ...
              <div className="mt-12">
                ...
                <ul className="mt-4">
                  <li className="flex items-center">
                    ...
                    <a
                      href="mailto:info@dcralph.com"
                      className="ml-4 text-sm text-[#007bff]"
                    >
                      <small className="block">Mail</small>
                      <strong>info@dcralph.com</strong>
                    </a>
                  </li>
                </ul>
              </div>
            ...
            <form className="ml-auto flex w-full flex-col items-center space-y-4">
              <input
                type="text"
                placeholder="Name"
